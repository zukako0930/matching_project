...
class BlockListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block_list" do
    assert_difference('BlockList.count') do
      post block_lists_url, params: { block_list: { blocked: @block_list.blocked, blocked_by: @block_list.blocked_by } }
    end
  ...
  test "should update block_list" do
    patch block_list_url(@block_list), params: { block_list: { blocked: @block_list.blocked, blocked_by: @block_list.blocked_by } }
